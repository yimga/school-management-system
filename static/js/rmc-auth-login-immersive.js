  ...
  root.querySelectorAll("[data-rmc-passkey-login]").forEach(function (button) {
    button.addEventListener("click", async function () {
      ...
      if (!window.PublicKeyCredential || !navigator.credentials) {
        announce((assistantCopy && assistantCopy.getAttribute("data-rmc-i18n-passkey-unsupported")) || "This browser does not support passkeys. Use email, SSO, or password.", true);
        return;
      }
