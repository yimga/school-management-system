...
SCANNER_BASELINE_MAP: dict[str, str | None] = {
    ...
    "scan_untranslated_template_text.py": "security-audit-baseline-untranslated-template-text.json",
    ...
    "scan_inline_event_handlers.py": "security-audit-baseline-inline-event-handlers.json",
