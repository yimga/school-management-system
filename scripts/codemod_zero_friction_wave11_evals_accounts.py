#!/usr/bin/env python3
"""Wave 11 — mechanical drawer/scroll/column-budget on evals + accounts templates."""
...
COLUMN_ALLOW: dict[str, str] = {
    ...
    "templates/accounts/migration_run_list.html": "migration-run-list-seven-column-operator-lens",
...
def main() -> int:
    changed: list[str] = []
    for sub in ("evals", "accounts"):
        for p in sorted((ROOT / "templates" / sub).glob("*.html")):
