#!/usr/bin/env python3
"""Wave 17 — finance + analytics + siteconfig zone friction burndown."""
...
ZONE_FILES = sorted(
    list((ROOT / "templates" / "finance").rglob("*.html"))
    + list((ROOT / "templates" / "analytics").glob("*.html"))
    + list((ROOT / "templates" / "siteconfig").rglob("*.html"))
)
