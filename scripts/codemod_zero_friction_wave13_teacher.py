#!/usr/bin/env python3
"""Wave 13 — teacher zone friction burndown (next-action strip, 5-col, drawer, empty states)."""
...
TEACHER_FILES = sorted((ROOT / "templates" / "teacher").glob("*.html"))
...
def patch_file(path: Path) -> bool:
    ...
    # Empty-list alerts → rmc_empty_state grammar (scorer empty_error_states -1).
    text = re.sub(
