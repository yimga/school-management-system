...
WAVE_CONTENT_MARKERS: dict[str, tuple[tuple[str, str], ...]] = {
    ...
    "wave3_flight_deck": (
        ...
        ("static/js/rmc-workflow-flight-deck.js", "data-rmc-flight-simulate"),
        ("apps/platform_runtime/workflow_attention_gateway.py", "compute_health"),
        ("apps/platform_runtime/workflow_kickoff_live.py", "open_orchestration_failure_count"),
        ("templates/components/rmc_workflow_kickoff_live.html", "data-rmc-kickoff-live"),
        ("static/js/rmc-workflow-kickoff-live.js", "issues_open"),
...
WAVE10X_URL_NAMES = (
    ...
    "platform_runtime:workflow_progress_simulate",
    "platform_runtime:workflow_progress_kickoff_live",
