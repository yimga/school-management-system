...
class APITestSuite:
    ...
    def setup_test_users(self):
        ...
        teacher = User.objects.create_user(
            username="teacher_test", email="teacher@test.com", password="testpass123"
        )
        ...
        student = User.objects.create_user(
            username="student_test", email="student@test.com", password="testpass123"
        )
        ...
        parent = User.objects.create_user(
            username="parent_test", email="parent@test.com", password="testpass123"
        )
        parent.role = "PARENT"
        parent.save()
    ...
    def test_notification_apis(self):
        ...
        try:
            ...
            if response.status_code == 200:
                print(
                    f"✓ GET /api/notifications/unread_count/ - Status: {response.status_code}"
                )
                self.results["passed"] += 1
            else:
                print(
    ...
    def test_announcement_api(self):
        ...
        try:
            ...
            if response.status_code in [200, 404]:
                print(
                    f"✓ GET /api/announcements/active/ - Status: {response.status_code}"
                )
                self.results["passed"] += 1
    ...
    def test_permissions(self):
        ...
        try:
            ...
            if response.status_code in [401, 403]:
                print(
                    f"✓ Unauthenticated access denied - Status: {response.status_code}"
                )
                self.results["passed"] += 1
            ...
            if response.status_code in [403, 401]:
                print(
                    f"✓ Student access to admin dashboard denied - Status: {response.status_code}"
                )
                self.results["passed"] += 1
