...
CONTROL_PLANE_SKELETON_ALLOWLIST = {
    ...
    "templates/apicenter/super/ai_center_friction.html",
    "templates/apicenter/super/ai_center_generate_kb.html",
    "templates/apicenter/super/ai_center_home.html",
    "templates/apicenter/super/ai_center_inventory.html",
    "templates/apicenter/super/ai_center_kb_drafts.html",
    "templates/apicenter/super/ai_center_query.html",
    "templates/apicenter/super/ai_center_settings.html",
    ...
    "templates/migration_cloud/connector/operator.html",
    "templates/migration_cloud/handoff_doc.html",
    "templates/migration_cloud/intake_new.html",
    "templates/migration_cloud/operator/audit_dashboard.html",
    "templates/migration_cloud/operator/command_center.html",
    "templates/migration_cloud/operator/dsar_runbook.html",
    "templates/migration_cloud/operator/smoke_history.html",
    "templates/migration_cloud/operator/smoke_trigger.html",
    "templates/migration_cloud/operator/token_list.html",
    "templates/migration_cloud/operator/token_mint.html",
    "templates/migration_cloud/operator/token_mint_result.html",
    "templates/migration_cloud/operator/token_rotation_chain.html",
    "templates/migration_cloud/operator/webhook_audit.html",
    "templates/migration_cloud/operator/webhook_delivery_log.html",
    "templates/migration_cloud/operator/webhook_list.html",
    "templates/migration_cloud/operator/webhook_subscribe.html",
    "templates/migration_cloud/progress.html",
    "templates/migration_cloud/super/health.html",
    "templates/migration_cloud/super/maa_v2_promotion.html",
