...
REQUIRED_SNIPPETS: tuple[tuple[str, str, str], ...] = (
    ("templates/schools/marketing_landing_v2.html", "_hero_live_campus_pulse.html", "live campus pulse on homepage"),
    ("templates/schools/marketing_landing_v2.html", "marketing-impact.css", "impact CSS on homepage"),
    ("templates/schools/marketing_landing_v2.html", "_video_portal.html", "video portal on homepage"),
