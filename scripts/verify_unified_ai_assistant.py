...
def main() -> int:
    checks = [
        ...
        ("evals-inline", _ok("templates/evals/compliance_dashboard.html", "help_module_inline_assistant.html")),
        ("siteconfig-inline", _ok("templates/siteconfig/console_domains_hub.html", "help_module_inline_assistant.html")),
        ("migration-inline", _ok("templates/migration_cloud/operator/command_center.html", "help_module_inline_assistant.html")),
        ("migration-siteconfig-prefixes", _ok("apps/portal/help_proactive_inline.py", "/siteconfig/")),
