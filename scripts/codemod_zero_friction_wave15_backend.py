#!/usr/bin/env python3
"""Wave 15 — backend zone friction burndown (people + accounts backend templates)."""
...
BACKEND_FILES = sorted(
    list((ROOT / "templates" / "people").glob("backend_*.html"))
    + list((ROOT / "templates" / "accounts").glob("backend_*.html"))
)
