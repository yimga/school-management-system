...
REQUIRED_FILES = (
    ...
    "static/marketing/css/mkt-one-record-scroll.css",
    "static/marketing/js/mkt-one-record-scroll.js",
    "templates/marketing/partials/sections/_one_record_scroll.html",
    "scripts/verify_marketing_one_record_scroll.py",
