...
urlpatterns = [
    ...
    path("migrate-from/<str:source_slug>/", migrate_marketing_page, name="marketing_migrate_from_source"),
    ...
    path("roles/principals/", role_marketing_page, {"role_slug": "principals"}, name="role_principals"),
    path("roles/district-leaders/", role_marketing_page, {"role_slug": "district-leaders"}, name="role_district_leaders"),
    path("for/principals/", role_marketing_page, {"role_slug": "principals"}, name="for_principals"),
    path("for/district-leaders/", role_marketing_page, {"role_slug": "district-leaders"}, name="for_district_leaders"),
    ...
    path("developers/app-building/", developer_marketing_page, {"section_slug": "app-building"}, name="developer_app_building"),
    ...
    path("marketplace/templates/", marketplace_marketing_page, {"section": "templates"}, name="marketplace_templates"),
    path("marketplace/blueprints/", marketplace_marketing_page, {"section": "blueprints"}, name="marketplace_blueprints"),
    path("marketplace/policy-packs/", marketplace_marketing_page, {"section": "policy-packs"}, name="marketplace_policy_packs"),
