"""Force-bind row-level security for orchestration (198-table burndown, 2026-09-03).
...
TABLES = [
    "orchestration_orchestrationrun",
]
...
def _policy_name(table):
    ...
    return f"orchestration_rls_{suffix}"
...
class Migration(migrations.Migration):
    ...
    dependencies = [("orchestration", "0004_rls_policy_default_deny")]
