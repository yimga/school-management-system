"""Force-bind row-level security for analytics (198-table burndown, 2026-09-03).
...
TABLES_FORCE = [
    ...
    "analytics_atriskoutcomelabel",
    "analytics_atriskshadowrun",
    "analytics_governedsavedreport",
    "analytics_gradeprediction",
    "analytics_gradepredictionlabel",
    "analytics_gradepredictionshadowrun",
    "analytics_interventionlog",
    "analytics_riskdigestrecipient",
    "analytics_riskfactor",
    "analytics_riskthresholds",
    "analytics_studentatrisksignal",
    "analytics_studentsignals",
]
...
def _policy_name(table):
    ...
    return f"analytics_rls_{suffix}"
...
class Migration(migrations.Migration):
    ...
    dependencies = [("analytics", "0030_rls_policy_default_deny")]
