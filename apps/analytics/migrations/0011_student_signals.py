        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("attendance_ratio_30d", "Attendance ratio (30 days)"),
                            ("grade_delta", "Grade delta vs prior term"),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["school", "student", "signal_type"],
                        name="analytics_s_school__739c39_idx",
                    ),
                    models.Index(
                        fields=["school", "-recorded_at"],
                        name="analytics_s_school__bfc0c9_idx",
                    ),
                ],
            },
        ),
