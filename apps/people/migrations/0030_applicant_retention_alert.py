...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["school", "stage"], name="people_appl_school__a1b2c3_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="applicant",
            index=models.Index(
                fields=["email", "school"], name="people_appl_email_d2e3f4_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="retentionalert",
            index=models.Index(
                fields=["school", "is_resolved"], name="people_reta_school__b3c4d5_idx"
            ),
        ),
    ]
