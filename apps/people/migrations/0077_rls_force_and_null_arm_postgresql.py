"""Force-bind row-level security for people (198-table burndown, 2026-09-03).
...
class Migration(migrations.Migration):
    ...
    dependencies = [("people", "0076_studentguardian_rls_postgresql")]
