"""Force-bind row-level security for lifecycle (198-table burndown, 2026-09-03).
...
def _policy_name(table):
    ...
    return f"lifecycle_rls_{suffix}"
...
class Migration(migrations.Migration):
    ...
    dependencies = [("lifecycle", "0010_edgeonboardingrun_skip_aspect_kind")]
