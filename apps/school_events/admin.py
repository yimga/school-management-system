...
@admin.register(EventVenue, site=admin_site)
...
@admin.register(EventSponsor, site=admin_site)
...
@admin.register(SchoolEvent, site=admin_site)
...
@admin.register(EventRegistration, site=admin_site)
