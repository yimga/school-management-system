"""Force-bind row-level security for school_events (198-table burndown, 2026-09-03).
...
class Migration(migrations.Migration):
    ...
    dependencies = [("school_events", "0004_rls_fk_scoped_children")]
