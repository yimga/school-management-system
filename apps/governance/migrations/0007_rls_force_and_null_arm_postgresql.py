"""Force-bind row-level security for governance (198-table burndown, 2026-09-03).
...
TABLES_FORCE = [
    "governance_schoolassignment",
    "governance_schoolcontextprofile",
]
...
def _policy_name(table):
    ...
    return f"governance_rls_{suffix}"
...
class Migration(migrations.Migration):
    ...
    dependencies = [("governance", "0006_rls_policy_default_deny")]
