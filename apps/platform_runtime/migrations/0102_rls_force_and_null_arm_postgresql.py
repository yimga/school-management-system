"""Force-bind row-level security for platform_runtime (198-table burndown, 2026-09-03).
...
TABLES_FORCE = [
    "platform_runtime_blueprintinstallation",
    "platform_runtime_clicktrackevent",
    "platform_runtime_offlineaction",
    "platform_runtime_operatorintent",
    "platform_runtime_operatortenantassignment",
    "platform_runtime_packinstallation",
    "platform_runtime_remotesupportsession",
    "platform_runtime_schoolonboardingprogress",
    "platform_runtime_tenantheartbeat",
    "platform_runtime_tenantretentionplaybookaction",
    "platform_runtime_tenantretentionplaybookauditlog",
]

TABLES = [
    "platform_runtime_configurationchangerequest",
    "platform_runtime_healthremediationlog",
]
...
def _policy_name(table):
    prefix = "platform_runtime_"
    suffix = table[len(prefix):] if table.startswith(prefix) else table
    return f"platform_runtime_rls_{suffix}"
...
class Migration(migrations.Migration):
    ...
    dependencies = [("platform_runtime", "0101_alter_offlineaction_action_type")]
