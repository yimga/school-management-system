"""Force-bind row-level security for policies (198-table burndown, 2026-09-03).
...
TABLES_FORCE = [
    "policies_policybundle",
    "policies_policydecisionlog",
    "policies_policyrule",
    "policies_scheduledpolicyoverride",
    "policies_tenantblueprint",
    "policies_tenantpolicyoverride",
]
...
class Migration(migrations.Migration):
    ...
    dependencies = [("policies", "0011_rls_null_school_arm_on_hybrid_tables")]
