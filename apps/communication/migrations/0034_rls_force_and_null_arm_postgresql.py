"""Force-bind row-level security for communication (198-table burndown, 2026-09-03).
...
def _policy_name(table):
    ...
    return f"communication_rls_{suffix}"
...
class Migration(migrations.Migration):
    ...
    dependencies = [("communication", "0033_outboundmessagequeue_updated_at")]
