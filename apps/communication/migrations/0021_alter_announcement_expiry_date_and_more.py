...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('communication', '0020_rename_comm_tmpl_school_key_active_idx_communicati_school__f12cbf_idx_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='expiry_date',
            field=models.DateTimeField(default=apps.communication.models.get_default_expiry),
        ),
        migrations.AlterField(
