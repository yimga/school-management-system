"""Force-bind row-level security for compliance (198-table burndown, 2026-09-03).
...
TABLES_FORCE = [
    "compliance_auditoraccessgrant",
    "compliance_consentrecord",
    "compliance_consentrequest",
    "compliance_eraserequest",
    "compliance_exportjob",
    "compliance_ferpadisclosure",
]

TABLES = [
    "compliance_nonrepudiationlogentry",
    "compliance_retentionrule",
]
...
def _policy_name(table):
    ...
    return f"compliance_rls_{suffix}"
...
class Migration(migrations.Migration):
    ...
    dependencies = [("compliance", "0023_auditlog_impersonation_context")]
