    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "applies_globally",
                    models.BooleanField(
                        default=False, help_text="If True, applies to all regions"
                    ),
                ),
                (
                    "is_mandatory",
                    models.BooleanField(default=True, help_text="Must be enforced"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "content",
                    models.TextField(
                        help_text="Full HTML/text content of the legal document"
                    ),
                ),
                (
                    "version",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DateField(
                        blank=True,
                        help_text="Compliance deadline for this region",
                        null=True,
                    ),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="regional_requirements",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "findings",
                    models.TextField(
                        help_text="Detailed findings from the compliance check"
                    ),
                ),
                (
                    "issues_found",
                    models.IntegerField(
                        default=0, help_text="Number of compliance issues found"
                    ),
                ),
                (
                    "issues_resolved",
                    models.IntegerField(
                        default=0, help_text="Number of issues already resolved"
                    ),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="checks",
                        to="compliance.regionalcompliancerequirement",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "prefix",
                    models.CharField(
                        help_text="Regional prefix for student IDs", max_length=5
                    ),
                ),
                (
                    "min_length",
                ...
                (
                    "example_id",
                    models.CharField(
                        help_text="Example of valid ID format", max_length=100
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "css_styling",
                    models.TextField(blank=True, help_text="CSS for styling"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "details",
                    models.JSONField(
                        blank=True, default=dict, help_text="Additional JSON data"
                    ),
                ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="compliance__region__4ed5f3_idx",
                    ),
                    models.Index(
                        fields=["action_type", "-timestamp"],
                        name="compliance__action__5178f0_idx",
                    ),
                    models.Index(
                        fields=["severity", "-timestamp"],
                        name="compliance__severit_3d66ac_idx",
                    ),
                ],
            },
        ),
