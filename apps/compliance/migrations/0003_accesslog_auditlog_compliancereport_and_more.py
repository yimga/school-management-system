    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "resource",
                    models.CharField(
                        help_text="URL path or API endpoint", max_length=500
                    ),
                ),
                (
                    "status",
                ...
                (
                    "error_message",
                    models.TextField(blank=True, help_text="If status != SUCCESS"),
                ),
                (
                    "user",
                    models.ForeignKey(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="compliance__user_id_aba0d1_idx",
                    ),
                    models.Index(
                        fields=["resource", "-timestamp"],
                        name="compliance__resourc_d20b61_idx",
                    ),
                    models.Index(
                        fields=["status", "-timestamp"],
                        name="compliance__status_ff39c6_idx",
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "model_name",
                    models.CharField(
                        help_text="e.g., 'Invoice', 'Evaluation'", max_length=100
                    ),
                ),
                (
                    "object_id",
                    models.CharField(
                        help_text="Primary key of affected object", max_length=200
                    ),
                ),
                (
                    "object_repr",
                ...
                (
                    ...
                    models.JSONField(
                        blank=True,
                        help_text="Pre-change state (for UPDATE/DELETE)",
                        null=True,
                    ),
                ),
                (
                    ...
                    models.JSONField(
                        blank=True,
                        help_text="Post-change state (for CREATE/UPDATE)",
                        null=True,
                    ),
                ),
                (
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["user", "-timestamp"],
                        name="compliance__user_id_71a297_idx",
                    ),
                    models.Index(
                    ...
                    models.Index(
                        ...
                        name="compliance__action_26c18c_idx",
                    ),
                    models.Index(
                        fields=["sensitivity", "-timestamp"],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "summary",
                    models.JSONField(help_text="High-level metrics and findings"),
                ),
                (
                    "details",
                    models.JSONField(
                        help_text="Detailed findings, grouped by category"
                    ),
                ),
                (
                    "issues",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="compliance__report__3ae4e7_idx",
                    ),
                    models.Index(
                        fields=["start_date", "end_date"],
                        name="compliance__start_d_7013a2_idx",
                    ),
                ],
            },
        ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="compliance__user_id_8d6177_idx",
                    ),
                    models.Index(
                        fields=["is_suspicious"], name="compliance__is_susp_cd79ff_idx"
                    ),
                ],
            },
        ),
