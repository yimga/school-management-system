"""Force-bind row-level security for marketplace (198-table burndown, 2026-09-03).
...
TABLES_FORCE = [
    ...
    "marketplace_apprating",
    "marketplace_marketplacemonetizationledgerentry",
    "marketplace_platformmarketplaceearning",
    "marketplace_tenantmarketplacesubscription",
]

TABLES = [
    "marketplace_webhookdelivery",
]
...
def _policy_name(table):
    ...
    return f"marketplace_rls_{suffix}"
...
class Migration(migrations.Migration):
    ...
    dependencies = [("marketplace", "0015_rls_policy_default_deny")]
