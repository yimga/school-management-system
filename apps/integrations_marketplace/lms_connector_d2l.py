...
def exchange_authorization_code_for_token(*, code: str, client_id: str,
    ...
    # v4.00.91 Wave 24 — H1 + H2 + H3 wiring on exchange path. Same shape
    # as Schoology — duplicated by design (the connectors are small and
    # this stays explicit + grep-friendly).
    from apps.integrations_marketplace.oauth_live_path_helpers import (
