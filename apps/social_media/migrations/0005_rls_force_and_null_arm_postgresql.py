"""Force-bind row-level security for social_media (198-table burndown, 2026-09-03).
...
def _policy_name(table):
    ...
    return f"social_media_rls_{suffix}"
...
class Migration(migrations.Migration):
    ...
    dependencies = [("social_media", "0004_outbox_retry_and_attribution_idempotency")]
