...
BACKEND_PRIMARY_CTAS = [
    {
        ...
        "fallback_url_name": "siteconfig:user_preferences",
    },
    {
        "label": "Manage Staff",
        "icon": "bi-person-gear",
...
BACKEND_ACTION_CHIPS = [
    ...
    },
    {
        ...
        "allow_key": "can_use_messages",
    },
    {
        "label": "Report Card Builder",
        "icon": "bi-file-earmark-richtext",
        "url_name": "siteconfig:reportcard_builder",
        "allow_key": "can_manage_reports",
    },
    {
        "label": "My Preferences",
        "icon": "bi-sliders",
        "url_name": "siteconfig:user_preferences",
        "allow_key": "always",
    },
    {
        "label": "System config",
...
BACKEND_WELCOME_ACTION_GRID = [
    ...
    },
    {
        ...
        "allow_key": "can_manage_finance",
    },
    {
        "label": "Add Student",
        "icon": "bi-person-plus",
        "url_name": "accounts:backend_student_create",
        "fallback_url_name": "admin:index",
        "item_id": "add_student",
        "allow_key": "can_manage_people",
    },
    {
        "label": "Add Teacher",
        "icon": "bi-person-badge",
        "url_name": "accounts:backend_teacher_create",
        "fallback_url_name": "admin:index",
        "item_id": "add_teacher",
        "allow_key": "can_manage_people",
    },
    ...
    },
    {
        ...
        "url_name": "reports:publish_term_results",
        "item_id": "manage_exams",
        "allow_key": "can_manage_reports",
    },
    {
        "label": "Announcements",
        "icon": "bi-megaphone",
        "url_name": "communication:announcement_create",
    ...
    },
    {
        ...
        "icon": "bi-shield-lock",
        "url_name": "accounts:rbac",
        "item_id": "roles_permissions",
        "allow_key": "can_manage_rbac",
    },
    {
        "label": "Document Library",
        "icon": "bi-folder2-open",
        "url_name": "portal:document_library_manage",
        "item_id": "document_library",
        "allow_key": "can_manage_settings",
    },
    {
        "label": "Donors & gifts",
        "icon": "bi-heart",
        "url_name": "accounts:advancement_donor_list",
        "item_id": "advancement_donors",
        "allow_key": "always",
    },
    {
    ...
    },
    {
        ...
        "icon": "bi-tools",
        "url_name": "accounts:ops_facilities",
        "item_id": "ops_facilities",
        "allow_key": "always",
    },
    {
        "label": "POS (stub)",
        "icon": "bi-cash-stack",
        "url_name": "accounts:ops_pos",
        "item_id": "ops_pos",
        "allow_key": "always",
    },
    {
        "label": "Package rollback",
        "icon": "bi-arrow-counterclockwise",
        "url_name": "siteconfig:installed_packages_rollback",
        "item_id": "package_rollback",
        "allow_key": "can_manage_settings",
    },
    {
        "label": "Activity log (tenant)",
        "icon": "bi-activity",
        "url_name": "accounts:tenant_activity_log",
        "item_id": "tenant_activity_log",
        "allow_key": "can_manage_settings",
    },
]
...
BACKEND_QUICK_LINKS = [
    {
        ...
        "icon": "bi-plug",
        "url_name": "accounts:district_lms_interop",
        "item_id": "district_interop",
        "allow_key": "can_manage_settings",
    },
    {
        "label": "Donors & gifts",
    ...
    },
    {
        "label": "Import Grades",
        "icon": "bi-upload",
        "url_name": "evals:grade_import_upload",
        "item_id": "import_grades",
        "allow_key": "can_manage_reports",
    },
    {
        "label": "Exams",
    ...
    },
    {
        "label": "Certification",
        "icon": "bi-award",
        "url_name": "accounts:certification_home",
        "item_id": "certification",
        "allow_key": "can_manage_reports",
    },
    {
        "label": "Documents",
...
BACKEND_COMMAND_PALETTE = [
    ...
    },
    {
        ...
        "fallback_url_name": "studio_os:shell",
        "allow_key": "can_manage_settings",
    },
    {
        "label": "Workflow Center",
    ...
    {
        "label": "Open fee reminder automation",
        "icon": "bi-clock-history",
        "url_name": "studio_os:automation",
        "fallback_url_name": "studio_os:workflow_center",
        "allow_key": "can_manage_settings",
    },
    {
        "label": "District & LMS interop",
    ...
    {
        "label": "Compliance overview (super)",
        "icon": "bi-clipboard-check",
        "url_name": "super:compliance_overview",
        "fallback_url_name": "super:trust_center",
        "allow_key": "can_manage_settings",
    },
    {
        "label": "Platform events log",
        "icon": "bi-journal-text",
        "url_name": "super:platform_events",
        "fallback_url_name": "super:trust_center",
        "allow_key": "can_manage_settings",
    },
    {
    ...
    {
        "label": "Configure grade reports",
        "icon": "bi-file-earmark-bar-graph",
        "url_name": "studio_os:output",
        "fallback_url_name": "reports:publish_term_results",
        "allow_key": "can_manage_reports",
    },
    {
        "label": "Go to district analytics",
        "icon": "bi-graph-up",
        "url_name": "super:analytics_overview",
        "fallback_url_name": "accounts:backend_dashboard",
        "allow_key": "can_manage_settings",
    },
    # Control plane heaviest flows (N8; only when user has control-plane access)
    {
        "label": "Create school",
        "icon": "bi-plus-circle",
        "url_name": "super:create_school_wizard",
        "fallback_url_name": "super:dashboard",
        "allow_key": "can_access_control_plane",
    },
    {
        "label": "Geography (region packs)",
        "icon": "bi-globe2",
    ...
    },
    {
        ...
        "fallback_url_name": "portal:teacher_attendance",
        "allow_key": "always",
    },
    {
        "label": "Teacher attendance hub",
        "icon": "bi-clipboard-check",
        "url_name": "portal:teacher_attendance",
        "fallback_url_name": "accounts:backend_dashboard",
        "allow_key": "always",
    },
    {
        ...
        "url_name": "analytics:at_risk_dashboard",
        "fallback_url_name": "accounts:backend_dashboard",
        "allow_key": "can_manage_settings",
    },
    {
    ...
    {
        "label": "Contact school (parent)",
        "icon": "bi-envelope",
        "url_name": "portal:parent_contact_school",
        "fallback_url_name": "portal:parent_dashboard",
        "allow_key": "always",
    },
    {
        "label": "Migration CSV diff",
        "icon": "bi-file-diff",
        "url_name": "super:migration_csv_diff",
        "fallback_url_name": "super:dashboard",
        "allow_key": "can_access_control_plane",
    },
    {
        "label": "Governed data query",
        "icon": "bi-database-check",
        "url_name": "super:governed_data_query",
        "fallback_url_name": "super:dashboard",
        "allow_key": "can_access_control_plane",
    },
]
...
ADMIN_HEADER_ACTIONS = [
    {
        ...
        "url_name": "siteconfig:user_preferences",
        "fallback_url_name": "admin:index",
        "css_class": "admin-dash__header-action",
        "append_next": True,
    },
    {
    ...
    },
    {
        ...
        "url_name": "studio_os:shell",
        "fallback_url_name": "siteconfig:user_preferences",
        "css_class": "admin-dash__header-action admin-dash__header-action--primary",
    },
]
...
def _resolve_actions(
    ...
    for s in specs:
        allow = (
            perms.get(s.get("allow_key", "always"), True)
            if s.get("allow_key") != "always"
            else True
        )
...
def _filter_actions_by_intent(
    ...
    by_id = {
        str(item.get("id", "")): item for item in welcome_action_grid if item.get("id")
    }
...
def get_backend_dashboard_actions(
    ...
    action_chips = _resolve_actions(
        BACKEND_ACTION_CHIPS, perms, safe_reverse, build_nav_item, dedupe_nav_items
    )
    welcome_action_grid = _resolve_actions(
        BACKEND_WELCOME_ACTION_GRID,
        perms,
        safe_reverse,
        build_nav_item,
    ...
    quick_links = _resolve_actions(
        BACKEND_QUICK_LINKS, perms, safe_reverse, build_nav_item, dedupe_nav_items
    )
    command_palette = _resolve_actions(
        BACKEND_COMMAND_PALETTE, perms, safe_reverse, build_nav_item, dedupe_nav_items
    )
    ...
    if intent and intent in VALID_DASHBOARD_INTENTS:
        ...
        if primary_spec:
            primary_url = safe(
                primary_spec["url_name"], primary_spec.get("fallback_url_name", "#")
            )
            if primary_url != "#":
                primary_ctas = [
                    {
...
def get_contextual_actions(
    ...
    *,
        ...
        out.append(
            {
                ...
                "reason": BACKEND_CONTEXTUAL_REASONS.get(
                    item_id, "Continue the highest-value workflow for this role."
                ),
            }
        )
    ...
    if workflow_progress:
        ...
        if workflow_progress.get("classrooms", 0) == 0 or not workflow_progress.get(
            "has_year_setup", False
        ):
    ...
    for index, item in enumerate(sliced):
        ...
        if recommendation:
            ...
            item["priority"] = recommendation.get("priority") or (
                "now" if index == 0 else "next" if index < 3 else "later"
            )
        else:
