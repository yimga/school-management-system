"""Global-local gap closure (batch 1488) — contract pins for plans_entitlements.
...
class ComputeQuotaContractsTest(SimpleTestCase):
    def test_artifact_and_key_path(self):
        ...
        key = ROOT / "apps/plans_entitlements"
