"""Force-bind row-level security for metadata (198-table burndown, 2026-09-03).
...
TABLES_FORCE = [
    ...
    "metadata_entitystate",
]

TABLES = [
    "metadata_dynamicfielddefinition",
    "metadata_layoutdefinition",
    "metadata_statemachinedefinition",
]
...
class Migration(migrations.Migration):
    ...
    dependencies = [("metadata", "0017_dfv_provenance_and_sync_anchor")]
