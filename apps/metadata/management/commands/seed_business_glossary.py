...
GLOSSARY_ENTRIES = [
    ("Class", "Instructional group; may be called form, homeroom, or year group depending on region.", "classroom", "", "en"),
    ("Form", "UK/Commonwealth term for class or year group.", "classroom", "", "en"),
    ("Homeroom", "Primary class or advisory group for a student.", "classroom", "", "en"),
    ("Year group", "Students in the same grade/year level.", "student", "grade_level", "en"),
    ("Cohort", "Group of students progressing together (e.g. by intake year).", "student", "", "en"),
    ...
    ("Tuition", "Instruction fee; may map to invoice or fee plan.", "invoice", "amount", "en"),
    ("Fee", "Charge for a good or service (e.g. activity fee, lab fee).", "invoice", "amount", "en"),
    ("Invoice", "Bill for fees/tuition sent to family.", "invoice", "", "en"),
    ("Guardian", "Person with legal responsibility for a student.", "parent_guardian", "", "en"),
    ("Parent", "Parent or guardian linked to a student.", "parent_guardian", "", "en"),
    ("Sponsor", "Person or organization responsible for payment (e.g. company, embassy).", "person", "", "en"),
    ("Report card", "Summary of grades and attendance for a term.", "", "", "en"),
    ("Transcript", "Official record of courses and grades.", "grade", "", "en"),
    ("Admission number", "Unique identifier for a student at a school.", "student", "admission_number", "en"),
    ...
    def handle(self, *args, **options):
        ...
        with transaction.atomic():
            ...
            if dry_run:
                ...
                self.stdout.write(f"Would create up to {len(GLOSSARY_ENTRIES)} entries ({created} new).")
            else:
                self.stdout.write(self.style.SUCCESS(f"Business glossary: {created} new entries; {len(GLOSSARY_ENTRIES)} total defined."))
