...
urlpatterns = [
    ...
    path("bulk/", bulk_report_console, name="bulk_report_console"),
    path("bulk/generate/", bulk_report_generate, name="bulk_report_generate"),
    path("bulk/print/", bulk_report_print, name="bulk_report_print"),
    path("bulk/share/", bulk_report_share, name="bulk_report_share"),
