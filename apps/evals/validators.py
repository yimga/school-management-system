...
class GradeValidator:
    ...
    def validate_evaluation(self, evaluation, weights) -> Dict:
        ...
        for component in ['seq1_score', 'seq2_score', 'exam_score', 'mock_score', 'practical_score']:
    ...
    def _detect_outlier(self, evaluation, weights) -> bool:
        ...
        sibling_evals = Evaluation.objects.filter(
