"""Force-bind row-level security for setup_studio (198-table burndown, 2026-09-03).
...
class Migration(migrations.Migration):
    ...
    dependencies = [("setup_studio", "0004_rls_policy_default_deny")]
