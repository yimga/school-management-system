"""Idempotent offline finance workflow captures (workforce money plane batch 1511)."""
...
class FinanceOfflineCaptureRecord(models.Model):
    ...
    school = models.ForeignKey(
        ...
        related_name="finance_offline_captures",
    )
    ...
    created_by = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="finance_offline_captures_created",
    )
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                ...
                name="uniq_finance_offline_capture_client_id",
            ),
        ]
        indexes = [
