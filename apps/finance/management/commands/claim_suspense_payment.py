...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument("--suspense-id", type=int, required=True, help="SuspensePayment id.")
        parser.add_argument(
            "--allocations",
            type=str,
            required=True,
        ...
        parser.add_argument("--notes", type=str, default="", help="Optional audit note.")
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS(f"Suspense {suspense.pk} updated: {result['status']}"))
