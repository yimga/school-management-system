"""Re-heal finance ``school`` FK columns on tenant schemas that drifted.
...
leaf this re-adds any missing finance ``school`` FK columns on EVERY tenant schema
...
def _heal(apps, schema_editor):
    ...
    ensure_app_school_id_columns("finance")


class Migration(migrations.Migration):

    dependencies = [
        ("finance", "0076_payment_refunded_amount"),
