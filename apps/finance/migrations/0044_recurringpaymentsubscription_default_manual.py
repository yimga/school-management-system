# Create PaymentPlan and RecurringPaymentSubscription (payment_processor default manual).
# These models were in code but had no migration; 0044 adds them so state is consistent.
