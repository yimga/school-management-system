"""Force-bind row-level security for finance (198-table burndown, 2026-09-03).
...
class Migration(migrations.Migration):
    ...
    dependencies = [("finance", "0082_backfill_arrears_invoice_school")]
