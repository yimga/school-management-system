"""Force-bind row-level security for requests (198-table burndown, 2026-09-03).
...
class Migration(migrations.Migration):
    ...
    dependencies = [("requests", "0005_rls_policy_default_deny")]
