...
urlpatterns = [
    ...
    path("me/switch-school", views_v1.MeSwitchSchoolView.as_view(), name="me-switch-school"),
    path("tenants/provision", views_v1.TenantsProvisionView.as_view(), name="tenants-provision"),
    path("config/education-dna", views_v1.EducationDNAView.as_view(), name="config-education-dna"),
    path("config/education-templates", views_v1.EducationTemplatesView.as_view(), name="config-education-templates"),
    path("config/integration-catalog", views_v1.IntegrationCatalogView.as_view(), name="config-integration-catalog"),
    path("config/risk-thresholds", views_v1.RiskThresholdsConfigView.as_view(), name="config-risk-thresholds"),
    path("tenants/<uuid:id>/modules", views_v1.TenantModulesView.as_view(), name="tenants-modules"),
    path("student/passport/<uuid:global_id>", views_v1.StudentPassportView.as_view(), name="student-passport"),
    ...
    path("vocational/log-hours", views_v1.VocationalLogHoursView.as_view(), name="vocational-log-hours"),
    path("vocational/verify-skill", views_v1.VocationalVerifySkillView.as_view(), name="vocational-verify-skill"),
    path("vocational/digital-badge/<int:student_id>", views_v1.VocationalDigitalBadgeView.as_view(), name="vocational-digital-badge"),
    path("vocational/certifications-expiring", views_v1.VocationalCertificationsExpiringView.as_view(), name="vocational-certifications-expiring"),
    path("scheduler/generate", views_v1.SchedulerGenerateView.as_view(), name="scheduler-generate"),
    path("scheduler/validate", views_v1.SchedulerValidateView.as_view(), name="scheduler-validate"),
    path("syllabus/pacing", views_v1.SyllabusPacingView.as_view(), name="syllabus-pacing"),
    ...
    path("super/recovery-rate", views_v1.SuperRecoveryRateView.as_view(), name="super-recovery-rate"),
    path("super/tenant-health", views_v1.SuperTenantHealthView.as_view(), name="super-tenant-health"),
    # Plan XII: GDPR "Export my school data"
    path("compliance/export-school", views_v1.ComplianceExportSchoolView.as_view(), name="compliance-export-school"),
    # Plan XVII: Enrollment forecasting stub
    path("enrollment/forecast", views_v1.EnrollmentForecastView.as_view(), name="enrollment-forecast"),
    # Plan III/XXI: Rosetta Stone (cross-tenant grade conversion)
    path("rosetta/convert", views_v1.RosettaConvertView.as_view(), name="rosetta-convert"),
    path("rosetta/scales", views_v1.RosettaScalesView.as_view(), name="rosetta-scales"),
    # Plan V: Parent Wallet top-up
    path("finance/wallet/top-up", views_v1.FinanceWalletTopUpView.as_view(), name="finance-wallet-top-up"),
    # Plan IV: MoE / Regulatory Export presets
    path("reports/regulatory-presets", views_v1.RegulatoryPresetsView.as_view(), name="reports-regulatory-presets"),
