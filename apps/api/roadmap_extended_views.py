...
def _staff_or_superuser(request):
    ...
    return user and user.is_authenticated and (getattr(user, "is_staff", False) or user.is_superuser)
...
class CommercialSelfServeAPI(View):
    ...
    def get(self, request):
        ...
        return JsonResponse({
            ...
            "flows": ["signup_school", "verify_signup", "api_trial_school", "onboarding_wizard"],
...
class NiceToHaveModulesAPI(View):
    ...
    def get(self, request):
        ...
        return JsonResponse({
            ...
            "modules": {
                "transport": {"status": "stub", "doc": "Route/Stop/Bus in schools; full bus management in backlog."},
                "hostel": {"status": "stub", "doc": "Rooms, occupancy; roadmap."},
                "canteen": {"status": "stub", "doc": "Menus, orders; roadmap."},
                "health": {"status": "stub", "doc": "Allergies, immunizations, nurse; FERPA; roadmap."},
                "inventory": {"status": "partial", "doc": "InventoryItem, Route, Stop, Bus; admin exists."},
                "biometric": {"status": "stub", "doc": "ID/biometric hardware integration; roadmap."},
            },
