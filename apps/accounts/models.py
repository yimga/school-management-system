...
class RolloverProposal(models.Model):
    """
    Plan II: Year-end rollover approval queue. One proposal per (school, source_year, target_year).
    process_student_promotions task creates PENDING proposal + items; operator reviews and approves; apply_rollover_proposal applies it.
    """
...
class RolloverProposalItem(models.Model):
    """Per-student row in a rollover proposal: suggested/approved next class and promotion status."""
