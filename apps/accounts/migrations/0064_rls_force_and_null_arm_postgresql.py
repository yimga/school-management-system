"""Force-bind row-level security for accounts (198-table burndown, 2026-09-03).
...
TABLES_FORCE = [
    "accounts_device_registration",
    "accounts_featurepermissionscope",
    "accounts_offline_access_intent",
    "accounts_offline_capability_token",
    "accounts_relationship_tuple",
    "accounts_tenantstaffinvite",
    "accounts_usertenantbinding",
]

TABLES = [
    "accounts_accessrole",
    "accounts_securityauditlog",
]
...
class Migration(migrations.Migration):
    ...
    dependencies = [("accounts", "0063_school_events_permission_codes")]
