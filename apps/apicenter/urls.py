...
urlpatterns = [
    ...
    path("webhooks/create/", views.webhook_subscription_create, name="webhook_subscription_create"),
    path("webhooks/<int:pk>/edit/", views.webhook_subscription_edit, name="webhook_subscription_edit"),
    path("webhooks/<int:pk>/delete/", views.webhook_subscription_delete, name="webhook_subscription_delete"),
