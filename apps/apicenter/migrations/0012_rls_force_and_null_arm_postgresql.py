"""Force-bind row-level security for apicenter (198-table burndown, 2026-09-03).
...
TABLES = [
    "apicenter_apikey",
    "apicenter_apiquota",
    "apicenter_developerapplication",
]
...
def _policy_name(table):
    ...
    return f"apicenter_rls_{suffix}"
...
class Migration(migrations.Migration):
    ...
    dependencies = [("apicenter", "0011_rls_policy_default_deny")]
