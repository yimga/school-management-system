    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                "indexes": [
                    models.Index(
                        fields=["operation_name", "traced_at"],
                        name="observabili_operati_1dc1cf_idx",
                    ),
                    models.Index(
                        fields=["success", "traced_at"],
                        name="observabili_success_59bbed_idx",
                    ),
                ],
            },
        ),
            ...
            options={
                "indexes": [
                    models.Index(
                        ...
                        name="observabili_metric__1112f0_idx",
                    ),
                    models.Index(
                        fields=["status", "recorded_at"],
                        name="observabili_status_b0031e_idx",
                    ),
                ],
            },
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="observability.systemhealthmetric",
                    ),
                ),
            ],
            options={
