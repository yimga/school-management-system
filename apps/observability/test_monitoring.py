...
class SystemHealthMetricTestCase(TestCase):
    ...
    def test_create_health_metric(self):
        ...
        metric = SystemHealthMetric.objects.create(
            metric_type="CPU", value=45.5, threshold=80.0, status="healthy"
        )
...
class HealthCheckAlertTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.metric = SystemHealthMetric.objects.create(
            metric_type="CPU", value=85.0, status="warning"
        )
    ...
    def test_create_alert(self):
        ...
        alert = HealthCheckAlert.objects.create(
            metric=self.metric, severity="WARNING", message="CPU usage above threshold"
        )
    ...
    def test_resolve_alert(self):
        ...
        alert = HealthCheckAlert.objects.create(
            metric=self.metric, severity="CRITICAL", message="Memory critical"
        )
