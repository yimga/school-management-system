"""Force-bind row-level security for feedback (198-table burndown, 2026-09-03).
...
TABLES = [
    ...
    "feedback_helpsearchquerylog",
    "feedback_supportaiinteractionreview",
    "feedback_supportaisessionrating",
    "feedback_supportdeflectionevent",
...
class Migration(migrations.Migration):
    ...
    dependencies = [("feedback", "0010_rls_fk_scoped_children")]
