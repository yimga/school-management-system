"""Force-bind row-level security for migration_cloud (198-table burndown, 2026-09-03).
...
TABLES = [
    "migration_cloud_migrationasset",
    "migration_cloud_migrationbundle",
...
class Migration(migrations.Migration):
    ...
    dependencies = [("migration_cloud", "0049_seed_alma_facts_skyward_profiles")]
