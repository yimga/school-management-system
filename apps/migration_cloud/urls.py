...
urlpatterns = [
    ...
    # v4.00.66 — operator force-purge confirmation endpoint (gated by signed token from the preview view).
    path("lms/diagnostics/retention-purge/", views_lms_diagnostics.lms_diagnostics_retention_purge, name="migration_cloud_lms_diagnostics_retention_purge"),  # rbac-allow: super-staff-migration-cloud-lms-retention-purge
