    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "code",
                    models.CharField(
                        help_text="Province/state code (e.g. NW, CA)", max_length=32
                    ),
                ),
                (
                    "name",
                    models.CharField(help_text="Province/state name", max_length=120),
                ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                to="siteconfig.educationsystemprofile",
            ),
        ),
        migrations.AddField(
