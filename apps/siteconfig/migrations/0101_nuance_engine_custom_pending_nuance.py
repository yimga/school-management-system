    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("logic_data", models.JSONField(default=dict, help_text="JSON-Logic structure. Only allowed ops run.")),
                ("human_description", models.TextField(blank=True, help_text="Plain-language description (e.g. for Principal); can be AI-generated.")),
                ("is_active", models.BooleanField(default=True)),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
                ("school", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="custom_nuances", to="schools.school")),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("school", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="pending_nuances", to="schools.school")),
            ],
            options={
                "ordering": ["-created_at"],
