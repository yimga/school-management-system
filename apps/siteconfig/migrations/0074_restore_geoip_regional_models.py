# Restore GeoIP/regional tables: 0061 removed them but geoip_service.py and
# test_geoip_service.py still use these models. Recreate so tests pass.
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('siteconfig', '0073_sitesettings_require_mfa_all_staff'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [
                    models.Index(fields=['country_code'], name='siteconfig__country_7a1c9d_idx'),
                    models.Index(fields=['ip_address'], name='siteconfig__ip_addr_8b2d1e_idx'),
                ],
            },
        ),
        migrations.CreateModel(
