    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('term_labels', models.JSONField(blank=True, default=apps.siteconfig.models.default_education_term_labels, help_text='Ordered labels for terms/semesters (e.g. ["Term 1", "Term 2", "Term 3"]).')),
                ...
                ('subject_seed', models.JSONField(blank=True, default=apps.siteconfig.models.default_education_subject_seed, help_text='Default subjects to seed when onboarding a school.')),
