"""Force-bind row-level security for siteconfig (198-table burndown, 2026-09-03).
...
def _policy_name(table):
    ...
    return f"siteconfig_rls_{suffix}"
...
class Migration(migrations.Migration):
    ...
    dependencies = [("siteconfig", "0213_syncconflict_field_provenance")]
