# Restore geoip/regional tables: migration 0025 removed them but geoip_service.py
# and test_geoip_service.py still use these models.
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('siteconfig', '0059_add_ink_onyx_console_themes'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [
                    models.Index(fields=['country_code'], name='siteconfig__country_c5f8b4_idx'),
                    models.Index(fields=['ip_address'], name='siteconfig__ip_addr_b868a0_idx'),
                ],
            },
        ),
        migrations.CreateModel(
