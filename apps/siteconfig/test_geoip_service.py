...
class RegionalConfigTestCase(TestCase):
    ...
    def test_region_uniqueness(self):
        ...
        RegionalConfig.objects.create(region="EAST_AFRICA", currency="KES")

        with self.assertRaises(Exception):
            RegionalConfig.objects.create(region="EAST_AFRICA", currency="UGX")
...
class IPWhitelistTestCase(TestCase):
    ...
    def test_add_to_whitelist(self):
        ...
        whitelist = IPWhitelist.objects.create(
            ip_address="192.168.1.1", region=self.region
        )
    ...
    def test_whitelist_query(self):
        ...
        IPWhitelist.objects.create(ip_address="10.0.0.1", region=self.region)
...
class RegionalAccessPolicyTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.region = RegionalConfig.objects.create(
            region="SOUTHERN_AFRICA", currency="ZAR"
        )
...
class LocationBasedAccessControlTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.region = RegionalConfig.objects.create(
            region="EAST_AFRICA", currency="KES"
        )
    ...
    def test_whitelist_access(self):
        ...
        IPWhitelist.objects.create(ip_address="203.0.113.20", region=self.region)
...
class RegionalDataLocalizationTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.region = RegionalConfig.objects.create(
            region="WEST_AFRICA", currency="NGN", timezone="Africa/Lagos"
        )
...
class GeoIPEventLoggerTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.region = RegionalConfig.objects.create(
            region="CENTRAL_AFRICA", currency="XAF"
        )
