...
from apps.siteconfig.integration_registry import backfill_service_integrations_from_legacy
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument("--school", type=str, default="", help="Optional school slug filter")
    ...
    def handle(self, *args, **options):
        ...
        results = backfill_service_integrations_from_legacy(school=school, dry_run=dry_run)
        ...
        if dry_run:
            ...
            self.stdout.write(self.style.SUCCESS(f"Backfill complete: created={created} updated={updated}"))
