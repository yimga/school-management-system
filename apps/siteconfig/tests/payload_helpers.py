"""Phase B test helpers: behavioral tenant-settings virtual keys live in RuntimeDefaults.payload."""
...
def persist_runtime_site_settings_payload(**kwargs: Any) -> None:
    ...
    _TenantSettingsModel._persist_runtime_payload_updates(kwargs)
