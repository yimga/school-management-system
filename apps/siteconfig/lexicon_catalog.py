...
LEXICON_REGISTRY: dict[str, tuple[str, str, str, str]] = {
    ...
    "specialty": (
        ...
        "Specialties",
        "academic",
        "Trade / filière track (Cameroon Lycée Technique — operational department).",
    ),
    "filiere": ("Filière", "Filières", "academic", "Francophone trade stream label."),
    "coefficient": (
        "Coefficient",
        "Coefficients",
        "records",
        "Subject weight in francophone weighted averages (coef).",
    ),
