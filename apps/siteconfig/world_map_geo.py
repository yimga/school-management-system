...
REGION_PALETTE: dict[str, dict[str, str]] = {
    "North America": {
        "cap": "rgba(52,211,153,0.045)",
        "cap_highlight": "rgba(52,211,153,0.18)",
        "cap_dim": "rgba(20,50,40,0.025)",
        "label": "rgba(110,231,183,0.95)",
        "label_country": "rgba(167,243,208,0.82)",
        "arc": "rgba(52,211,153,0.52)",
        "side": "rgba(16,185,129,0.12)",
    },
    "West Africa": {
        "cap": "rgba(251,191,36,0.045)",
        "cap_highlight": "rgba(251,191,36,0.18)",
        "cap_dim": "rgba(60,45,10,0.025)",
        "label": "rgba(253,224,71,0.95)",
        "label_country": "rgba(254,240,138,0.82)",
        "arc": "rgba(251,191,36,0.52)",
        "side": "rgba(245,158,11,0.12)",
    },
    "Europe": {
        "cap": "rgba(129,140,248,0.04)",
        "cap_highlight": "rgba(129,140,248,0.16)",
        "cap_dim": "rgba(30,30,60,0.025)",
        "label": "rgba(165,180,252,0.95)",
        "label_country": "rgba(199,210,254,0.82)",
        "arc": "rgba(129,140,248,0.52)",
        "side": "rgba(99,102,241,0.11)",
    },
    "Asia · Oceania": {
        "cap": "rgba(244,114,182,0.04)",
        "cap_highlight": "rgba(244,114,182,0.16)",
        "cap_dim": "rgba(60,20,40,0.025)",
        "label": "rgba(249,168,212,0.95)",
        "label_country": "rgba(251,207,232,0.82)",
        "arc": "rgba(244,114,182,0.52)",
        "side": "rgba(236,72,153,0.11)",
    },
    "Other": {
        "cap": "rgba(148,163,184,0.035)",
        "cap_highlight": "rgba(148,163,184,0.13)",
        "cap_dim": "rgba(40,45,55,0.025)",
        "label": "rgba(203,213,225,0.88)",
        "label_country": "rgba(203,213,225,0.72)",
        "arc": "rgba(148,163,184,0.42)",
        "side": "rgba(100,116,139,0.10)",
    },
}
...
def build_globe_payload(
    ...
    *,
    ...
    return {
        "markers": markers,
        "theme": {
            "atmosphere": "rgba(99,102,241,0.35)",
            "globeColor": "#10182e",
            "globeEmissive": "#1e1b4b",
            "polygonCap": "rgba(148,163,184,0.08)",
            "polygonSide": "rgba(99,102,241,0.14)",
            "polygonStroke": "rgba(226,232,240,0.24)",
            "polygonCapDim": "rgba(71,85,105,0.04)",
            "polygonCapHighlight": "rgba(129,140,248,0.24)",
        },
