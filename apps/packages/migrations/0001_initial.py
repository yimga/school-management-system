        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "action",
                    models.CharField(
                        choices=[("apply", "Apply"), ("rollback", "Rollback")],
                        default="apply",
                        max_length=20,
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.JSONField(
                        blank=True,
                        default=dict,
                        help_text="Platform/region constraints.",
                    ),
                ),
                (
                    "payload_sections",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        db_index=True,
                        help_text="Stable package identifier.",
                        max_length=120,
                    ),
                ),
                (
                ...
                (
                    "version",
                    models.CharField(
                        help_text="Installed version string.", max_length=80
                    ),
                ),
                (
                    "scope",
