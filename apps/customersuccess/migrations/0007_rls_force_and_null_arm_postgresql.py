"""Force-bind row-level security for customersuccess (198-table burndown, 2026-09-03).
...
TABLES_FORCE = [
    "customersuccess_admininactivityalert",
    "customersuccess_forecastscenario",
    "customersuccess_helpcentersource",
    "customersuccess_tenanthealthscore",
    "customersuccess_tenantinterventionsuggestion",
    "customersuccess_tenantmaturityscore",
    "customersuccess_tenantriskalert",
    "customersuccess_workflowfailureevent",
]
...
class Migration(migrations.Migration):
    ...
    dependencies = [("customersuccess", "0006_rls_policy_default_deny")]
