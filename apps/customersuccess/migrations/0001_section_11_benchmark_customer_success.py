    ...
    operations = [
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("health_below", "Health score below threshold"),
                            ("inactivity_days", "Admin inactivity (days)"),
                            ("risk_alert_red", "Red risk alert"),
                        ],
                        db_index=True,
                        max_length=40,
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Display name, e.g. 'Private K12 Cameroon'",
                        max_length=120,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "priority",
                    models.PositiveSmallIntegerField(default=5, help_text="1=highest"),
                ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="customersuc_school__ea5a37_idx",
                    )
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "payload",
                    models.JSONField(
                        blank=True, default=dict, help_text="Breakdown or evidence keys"
                    ),
                ),
                (
                    "computed_at",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["school", "dimension", "-computed_at"],
                        name="customersuc_school__495e9b_idx",
                    )
                ],
            },
        ),
