"""Force-bind row-level security for billing (198-table burndown, 2026-09-03).
...
class Migration(migrations.Migration):
    ...
    dependencies = [("billing", "0020_processorrevenueshareaccrual")]
