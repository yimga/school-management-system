            ...
            state_operations=[
                ...
                migrations.CreateModel(
                    ...
                    fields=[
                        ...
                        ("is_graduate", models.BooleanField(default=False, help_text="If True, student will be marked Alumni and removed from active roll.")),
                        ...
                        ("proposal", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="items", to="academics.rolloverproposal")),
                ...
                migrations.CreateModel(
                    ...
                    fields=[
                        ("id", models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name="ID")),
                        ("name", models.CharField(help_text="Holiday name (e.g., 'Christmas Break', 'Eid al-Fitr')", max_length=200)),
                        ("date_start", models.DateField(help_text="Holiday start date")),
                        ("date_end", models.DateField(help_text="Holiday end date (inclusive)")),
                        ("holiday_type", models.CharField(choices=[("school_holiday", "School Holiday"), ("public_holiday", "Public Holiday"), ("exam_period", "Exam Period"), ("religious", "Religious Holiday"), ("special_event", "Special Event")], help_text="Type of holiday", max_length=50)),
                        ("is_working_day", models.BooleanField(default=False, help_text="Some regions work during certain holidays (e.g., religious holidays)")),
