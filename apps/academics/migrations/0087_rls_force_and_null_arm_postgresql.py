"""Force-bind row-level security for academics (198-table burndown, 2026-09-03).
...
def _policy_name(table):
    ...
    return f"academics_rls_{suffix}"
...
class Migration(migrations.Migration):
    ...
    dependencies = [("academics", "0086_incident_edge_sync_rail")]
