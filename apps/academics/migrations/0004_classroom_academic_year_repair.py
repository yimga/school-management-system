# Generated by Django 5.2.10 on 2026-01-18 21:45

from django.db import migrations


def ensure_classroom_academic_year(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("academics", "0003_classroom_academic_year_backfill"),
    ]

    operations = [
        migrations.RunPython(ensure_classroom_academic_year, migrations.RunPython.noop),
    ]
