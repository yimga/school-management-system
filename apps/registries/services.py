...
GRADE_SCALE_SEED_DEFAULTS: tuple[dict, ...] = (
    ...
    },
    {
        ...
        "family": "binary",
        "sort_order": 50,
        "range_definition": {"min": 0, "max": 100, "pass_threshold": 50},
        "metadata": {
            "ranking_mode": "average",
            "boundary_map": [
    ...
    },
    {
        ...
        "metadata": {
            "ranking_mode": "average",
            "boundary_map": [
                {"grade": "Exceeding", "min": 85, "max": 100},
                {"grade": "Meeting", "min": 70, "max": 84.99},
                {"grade": "Approaching", "min": 50, "max": 69.99},
                {"grade": "Beginning", "min": 0, "max": 49.99},
            ],
        },
    },
    {
        ...
        "country_code": "GB",
        "sort_order": 100,
        "range_definition": {"min": 1, "max": 9, "pass_threshold": 4},
        "metadata": {
            "ranking_mode": "average",
            "boundary_map": [
                {"grade": "9", "min": 9, "max": 9},
                {"grade": "7", "min": 7, "max": 8.99},
                {"grade": "4", "min": 4, "max": 6.99},
                {"grade": "1", "min": 1, "max": 3.99},
            ],
        },
    },
    {
        ...
        "family": "numeric",
        "sort_order": 110,
        "range_definition": {"min": 1, "max": 7, "pass_threshold": 4},
        "metadata": {
            "ranking_mode": "average",
            "boundary_map": [
                {"grade": "7", "min": 7, "max": 7},
                {"grade": "6", "min": 6, "max": 6.99},
                {"grade": "5", "min": 5, "max": 5.99},
                {"grade": "4", "min": 4, "max": 4.99},
                {"grade": "3", "min": 1, "max": 3.99},
            ],
        },
    },
    {
        ...
        "country_code": "DE",
        "sort_order": 120,
        "range_definition": {"min": 1, "max": 6, "pass_threshold": 4},
        "metadata": {
            "ranking_mode": "average",
            "boundary_map": [
                {"grade": "1", "min": 1, "max": 1.49},
                {"grade": "2", "min": 1.5, "max": 2.49},
                {"grade": "3", "min": 2.5, "max": 3.49},
                {"grade": "4", "min": 3.5, "max": 4.49},
                {"grade": "5", "min": 4.5, "max": 5.49},
                {"grade": "6", "min": 5.5, "max": 6},
            ],
        },
    },
    {
        ...
        "country_code": "IN",
        "sort_order": 130,
        "range_definition": {"min": 0, "max": 10, "pass_threshold": 4},
    ...
    },
    {
        ...
        "country_code": "FR",
        "sort_order": 140,
        "range_definition": {"min": 0, "max": 20, "pass_threshold": 10},
        "metadata": {"ranking_mode": "average"},
    },
    {
        "code": "US_LETTER",
