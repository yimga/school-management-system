...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.CharField(blank=True, help_text='Default calendar system code.', max_length=48),
        ),
        migrations.AddField(
            model_name='countryregistry',
            name='default_terminology_pack',
            field=models.CharField(blank=True, help_text='Default terminology pack code.', max_length=48),
        ),
        migrations.AddField(
            model_name='countryregistry',
            name='writing_direction',
            field=models.CharField(blank=True, default='ltr', help_text='ltr or rtl.', max_length=8),
        ),
        migrations.AddField(
            model_name='currencyregistry',
            name='thousands_separator_style',
            field=models.CharField(blank=True, help_text='e.g. comma, space, none.', max_length=16),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(blank=True, help_text='e.g. identity, academic, health.', max_length=48)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=120)),
                ('description', models.TextField(blank=True)),
                ('family', models.CharField(blank=True, help_text='e.g. numeric, letter, gpa, competency.', max_length=48)),
                ('range_definition', models.JSONField(blank=True, default=dict, help_text='Min/max, pass threshold, scale steps.')),
                ('country_code', models.CharField(blank=True, db_index=True, max_length=2)),
                ('metadata', models.JSONField(blank=True, default=dict)),
                ('is_active', models.BooleanField(default=True)),
                ('sort_order', models.PositiveIntegerField(default=0)),
