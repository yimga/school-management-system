"""Force-bind row-level security for registries (198-table burndown, 2026-09-03).
...
TABLES_FORCE = [
    "registries_tenantattendancecode",
    "registries_tenantfeetypeentry",
...
def _policy_name(table):
    ...
    return f"registries_rls_{suffix}"
...
class Migration(migrations.Migration):
    ...
    dependencies = [("registries", "0014_backfill_grade_scale_country_code")]
