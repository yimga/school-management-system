...
class GuardianLinkingService:
    ...
    def create_invitation(student_id, parent_email, created_by):
        ...
        expires_at = timezone.now() + timedelta(days=GuardianLinkingService.INVITATION_VALIDITY_DAYS)
...
class PortalSecurityService:
    ...
    @staticmethod
    def log_action(parent_id, action, description, ip_address, user_agent, details=None):
        """Log portal action"""
