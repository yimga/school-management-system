...
class AnnouncementAdmin(admin.ModelAdmin):
    ...
    autocomplete_fields = ("created_by",)
    fieldsets = (
        ("Announcement Content", {"fields": ("title", "message", "banner_type")}),
        ("Display Settings", {"fields": ("is_active", "start_date", "end_date")}),
        (
            "Metadata",
            {
...
class FormSignatureAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Form & Signer", {"fields": ("form_document", "student", "parent")}),
        ("Signature Status", {"fields": ("status", "signed_at", "expires_at")}),
        (
            "Signature Data",
            {
