        ...
        SettingsCategory(
            ...
            entries=[
                SettingsEntry("Grading scale", "0–100, A–F, 0–20 (West Africa), IB, custom.",
                              "bi-list-ol",
                              _try_url("siteconfig:grading_settings"),
                ...
                SettingsEntry("Academic year & terms", "Calendar, term dates, exam windows.",
                              "bi-calendar3",
                              _try_url("siteconfig:academic_years_setup_evidence"),
        ...
        SettingsCategory(
            ...
            entries=[
                ...
                SettingsEntry("Currency & taxes", "Default currency, multi-currency, VAT rules.",
                              ...
                              _try_url("siteconfig:currency_settings"),
        ...
        SettingsCategory(
            ...
            entries=[
                SettingsEntry("Email & SMS",
                              ...
                              "email smtp sender sms twilio sendgrid mailgun postmark"),
        ...
        SettingsCategory(
            ...
            entries=[
                SettingsEntry("Region & residency",
                              ...
                              "bi-geo-alt",
                              _try_url("siteconfig:region_validation"),
