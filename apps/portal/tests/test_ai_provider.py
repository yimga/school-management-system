...
class AiProviderTests(SimpleTestCase):
    ...
    @override_settings(AI_PROVIDER_PREFERENCE="ollama,gemini,rules", AI_ALLOW_RULES_FALLBACK=True)
    ...
    @override_settings(AI_PROVIDER_PREFERENCE="ollama,gemini,rules", AI_ALLOW_RULES_FALLBACK=False)
    @patch("apps.portal.ai_provider._call_gemini", return_value=None)
    @patch("apps.portal.ai_provider._call_ollama", return_value=None)
    ...
    @override_settings(AI_PROVIDER_PREFERENCE="ollama,rules")
