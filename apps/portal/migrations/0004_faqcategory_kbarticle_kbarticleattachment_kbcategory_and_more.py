    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "content",
                    models.TextField(
                        help_text="Detailed article content", verbose_name="Content"
                    ),
                ),
                (
                    "content_html",
                    models.TextField(blank=True, verbose_name="Content (HTML)"),
                ),
                (
                    "difficulty",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_screenshot",
                    models.BooleanField(default=True, verbose_name="Is Screenshot"),
                ),
                (
                    "created_at",
                    models.DateTimeField(auto_now_add=True, verbose_name="Created At"),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("FAQ_SUBMIT", "FAQ Submitted"),
                            ("FAQ_APPROVE", "FAQ Approved"),
                            ("ARTICLE_SUBMIT", "Article Submitted"),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Rich text answer format",
                        verbose_name="Answer (HTML)",
                    ),
                ),
                (
                    "status",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="portal_faq_status_731485_idx",
                    ),
                    models.Index(
                        fields=["is_featured", "-view_count"],
                        name="portal_faq_is_feat_fc5b80_idx",
                    ),
                ],
            },
        ),
        migrations.AddIndex(
            model_name="kbarticle",
            index=models.Index(
                fields=["status", "category"], name="portal_kbar_status_b9a195_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="kbarticle",
            index=models.Index(
                fields=["is_featured", "-view_count"],
                name="portal_kbar_is_feat_0a8edc_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="kbarticle",
            index=models.Index(
                fields=["-published_at"], name="portal_kbar_publish_3cf12c_idx"
            ),
        ),
    ]
