...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name="portalfeatureitem",
            index=models.Index(
                fields=["feature", "is_active"], name="portal_port_feature_17bfaa_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="portalfeatureitem",
            index=models.Index(
                ...
                name="portal_port_documen_097a93_idx",
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                limit_choices_to={"document_type": "FORM", "requires_signature": True},
                on_delete=django.db.models.deletion.CASCADE,
                related_name="signatures",
                to="portal.portalfeatureitem",
            ),
        ),
        migrations.AddField(
            model_name="formsignature",
        ...
        migrations.AddIndex(
            model_name="formsignature",
            index=models.Index(
                fields=["form_document", "status"],
                name="portal_form_form_do_1c8f6e_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="formsignature",
            index=models.Index(
                fields=["student", "status"], name="portal_form_student_b5b494_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="formsignature",
            index=models.Index(
                fields=["parent", "status"], name="portal_form_parent__d5dc66_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="formsignature",
            index=models.Index(
                fields=["expires_at", "status"], name="portal_form_expires_96999a_idx"
            ),
        ),
