"""Re-heal portal ``school`` FK columns on tenant schemas that drifted.
...
leaf this re-adds any missing portal ``school`` FK columns on EVERY tenant schema
...
def _heal(apps, schema_editor):
    ...
    ensure_app_school_id_columns("portal")


class Migration(migrations.Migration):

    dependencies = [
        ("portal", "0042_rls_policy_default_deny"),
