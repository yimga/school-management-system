...
class FAQCategory(models.Model):
    ...
    icon = models.CharField(
        ...
        max_length=50,
        blank=True,
        help_text="CSS icon class (e.g., 'fa-question-circle')",
    )
    display_order = models.PositiveIntegerField(
        _("Display Order"), default=0, help_text="Lower numbers appear first"
    )
...
class FAQ(models.Model):
    ...
    answer_html = models.TextField(
        _("Answer (HTML)"), blank=True, help_text="Rich text answer format"
    )
...
class KBArticle(models.Model):
    ...
    summary = models.TextField(
        _("Summary"), max_length=500, help_text="Brief description for listings"
    )
    ...
    estimated_read_time = models.PositiveIntegerField(
        _("Estimated Read Time (minutes)"), default=5
    )
    tags = models.CharField(_("Tags"), max_length=500, blank=True)
    related_articles = models.ManyToManyField(
        "self", blank=True, symmetrical=False, verbose_name=_("Related Articles")
    )
...
class KBArticleAttachment(models.Model):
    ...
    uploaded_by = models.ForeignKey(
        User, on_delete=models.SET_NULL, null=True, verbose_name=_("Uploaded By")
    )
    created_at = models.DateTimeField(_("Created At"), auto_now_add=True)
...
class KBComment(models.Model):
    ...
    is_helpful = models.BooleanField(
        _("Is Helpful"),
        default=False,
        help_text="Marked by moderators as particularly helpful",
    )
    created_at = models.DateTimeField(_("Created At"), auto_now_add=True)
    updated_at = models.DateTimeField(_("Updated At"), auto_now=True)
...
class UserContribution(models.Model):
    ...
    user = models.ForeignKey(
        User,
        on_delete=models.CASCADE,
        related_name="kb_contributions_log",
        verbose_name=_("User"),
    )
    contribution_type = models.CharField(
        _("Contribution Type"), max_length=20, choices=CONTRIBUTION_TYPES
    )
