...
urlpatterns = [
    ...
    path('article/<slug:article_slug>/download-odt/', views_kb.kb_article_download_odt, name='kb_article_download_odt'),
    path('article/<slug:article_slug>/download-docx/', views_kb.kb_article_download_docx, name='kb_article_download_docx'),
    path('article/<slug:article_slug>/download-pdf/', views_kb.kb_article_download_pdf, name='kb_article_download_pdf'),
    path('article/<slug:article_slug>/vote/', views_kb.kb_article_vote, name='kb_article_vote'),
    path('article/<slug:article_slug>/comment/', views_kb.kb_comment_add, name='kb_comment_add'),
