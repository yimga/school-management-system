    ...
    def test_manager_urlconf_uses_platform_admin_site(self):
        ...
        admin_pattern = next(
            (
                ...
                and "admin" in str(getattr(p.pattern, "_route", ""))
            ),
            None,
        )
...
class Wave2TenantAdminOnlyOnTenantHostTests(TestCase):
    ...
    def test_tenant_admin_site_has_tenant_index_template(self):
        ...
        self.assertEqual(
            tenant_admin_site.index_template_name, "admin/index_tenant.html"
        )
    ...
    def test_platform_admin_site_has_platform_index_template(self):
        ...
        self.assertEqual(
            platform_admin_site.index_template_name, "admin/index_superadmin.html"
        )
...
class Wave2GraphQLGlobalSchoolsRestrictedTests(TestCase):
    ...
    def test_graphql_school_count_restricted_for_tenant_staff(self):
        ...
        data = result.data or {}
        self.assertIsNone(
            data.get("schoolCount"), "Tenant staff must not get schoolCount."
        )
    ...
    def test_graphql_schools_restricted_for_tenant_staff(self):
        ...
        data = result.data or {}
        self.assertEqual(
            data.get("schools"), [], "Tenant staff must get empty schools list."
        )
