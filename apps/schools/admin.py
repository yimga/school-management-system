...
class SchoolAdmin(admin.ModelAdmin):
    ...
    def _school_fieldsets():
        if _school_has_billing():
            return (
                (None, {"fields": ("name", "slug", "subdomain", "sub_system", "is_active", "default_region", "timezone")}),
                ("Plan & billing", {"fields": ("plan", "addons", "billing_type", "waiver_note")}),
                ...
                ("Parent school", {"fields": ("parent_school",)}),
