...
STOCK_MEDIA_REGISTRY: dict[str, dict[str, Any]] = {
    ...
    "platform-grading-report-cards": {
        ...
        "hero_photo_default": "https://images.unsplash.com/photo-1524178232363-1fb2b075b655?auto=format&fit=crop&w=1600&q=80",
        "credit": "Photo: Unsplash · classroom (illustrative)",
    ...
    "ascension-run": {
        "hero_photo_env": "MARKETING_STOCK_ASCENSION_RUN_URL",
        "hero_photo_default": "https://images.unsplash.com/photo-1503676260728-1c00da094a0b?auto=format&fit=crop&w=1600&q=80",
        "credit": "Photo: Unsplash · enrollment morning (illustrative)",
        "alt": "Families arriving for enrollment — admissions pulse",
    },
    "ascension-talk": {
        "hero_photo_env": "MARKETING_STOCK_ASCENSION_PARENT_URL",
        "hero_photo_default": "https://images.unsplash.com/photo-1516627145497-ae6968895b74?auto=format&fit=crop&w=1600&q=80",
        "credit": "Photo: Unsplash · parent and child (illustrative)",
        "alt": "Parent receiving calm school update on phone",
    },
    "ascension-teach": {
        "hero_photo_env": "MARKETING_STOCK_ASCENSION_TEACH_URL",
        "hero_photo_default": "https://images.unsplash.com/photo-1524178232363-1fb2b075b655?auto=format&fit=crop&w=1600&q=80",
        "credit": "Photo: Unsplash · collaborative classroom (illustrative)",
        "alt": "Collaborative classroom learning — illustrative",
    },
    "ascension-pay": {
        "hero_photo_env": "MARKETING_STOCK_ASCENSION_PAY_URL",
        "hero_photo_default": "https://images.unsplash.com/photo-1554224155-6726b3ff858f?auto=format&fit=crop&w=1600&q=80",
        "credit": "Photo: Unsplash · school finance (illustrative)",
        "alt": "School finance and split payments — illustrative",
    },
    "ascension-govern": {
        "hero_photo_env": "MARKETING_STOCK_ASCENSION_GOVERN_URL",
        "hero_photo_default": "https://images.unsplash.com/photo-1580582932707-520aedcedb7d?auto=format&fit=crop&w=1600&q=80",
        "credit": "Photo: Unsplash · rural campus resilience (illustrative)",
        "alt": "School operating through connectivity challenges",
    },
    "ascension-grow": {
        "hero_photo_env": "MARKETING_STOCK_ASCENSION_GROW_URL",
        "hero_photo_default": "https://images.unsplash.com/photo-1552664730-d307ca884978?auto=format&fit=crop&w=1600&q=80",
        "credit": "Photo: Unsplash · leadership review (illustrative)",
        "alt": "School leadership reviewing multi-campus outcomes",
    },
    "ascension-parent": {
        "hero_photo_env": "MARKETING_STOCK_ASCENSION_PARENT_URL",
        "hero_photo_default": "https://images.unsplash.com/photo-1516627145497-ae6968895b74?auto=format&fit=crop&w=1600&q=80",
