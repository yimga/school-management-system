...
INSTITUTION_PREMIUM_LAYER: dict[str, dict] = {
    "private-schools": {
        ...
        "stock_photo_static": "images/marketing/solution-private-growth-engine.svg",
    ...
    "international-schools": {
        ...
        "stock_photo_static": "images/marketing/solution-international-global-model.svg",
    ...
    "multi-campus": {
        "problem_section": {
            "title": "Many campuses, one governance layer",
            "body": "Groups need shared policy, reporting, and audit visibility—not HQ overriding each campus’s calendar, currency, or assessment rules. RunMyCampus keeps local execution on every campus while leadership sees the network clearly.",
        },
        "recommended_modules": [
            {"label": "Analytics", "path": "/platform/analytics/"},
            {"label": "Security & Governance", "path": "/platform/security/"},
        ...
        "stock_photo_static": "images/marketing/solution-multi-campus-command-center.svg",
        ...
        "global_config_note": "Governance and reporting roll up network-wide; calendars, fees, portals, and marketplace apps activate per campus.",
    },
    "faith-based-schools": {
        "problem_section": {
        ...
        "stock_photo_static": "images/marketing/solution-faith-community-hub.svg",
    ...
    "growing-school-networks": {
        ...
        "stock_photo_static": "images/marketing/solution-growing-network-playbook.svg",
