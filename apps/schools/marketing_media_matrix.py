...
MARKETING_COPY_REGISTRY: dict[str, dict[str, str]] = {
    "US": {
        ...
        "txt_speed_duel_headline": "Fifteen clicks vs one command.",
        "txt_speed_duel_lead": "Legacy SIS stacks make staff hunt through nested menus. RunMyCampus compiles intent into governed tool calls — simulated sub-100ms on this page.",
        "txt_zero_ui_headline": "Zero-UI orchestration — kill the tab maze.",
        "txt_zero_ui_lead": "Type what you need. Watch the OS compile structured tool calls and layout slots — no multi-form integration sprawl.",
        "txt_trinity_headline": "Built for the connection you actually have.",
        "txt_trinity_lead": "From 2G offline PWA loops to 4K NOC walls — same kernel, mirrored RTL/LTR, payloads under 15 KB.",
        "txt_enterprise_headline": "One parent org. Many institution types. One login.",
        "txt_enterprise_lead": "Dioceses, PE groups, and ministries run K-12, polytechnics, and universities on one poly-institutional ledger.",
    },
    "SA": {
        ...
        "txt_speed_duel_headline": "خمس عشرة نقرة مقابل أمر واحد.",
        "txt_speed_duel_lead": "أنظمة SIS القديمة تُجبر الموظفين على التنقل في قوائم متداخلة. RunMyCampus يُحوّل النية إلى أوامر محكومة.",
        "txt_zero_ui_headline": "تنسيق بلا واجهة — انهِ متاهة التبويبات.",
        "txt_zero_ui_lead": "اكتب ما تحتاجه. شاهد النظام يُجمّع أوامر JSON ومسارات الواجهة.",
        "txt_trinity_headline": "مُصمّم للاتصال الذي لديك فعلاً.",
        "txt_trinity_lead": "من PWA على 2G إلى جدران NOC بدقة 4K — نفس النواة ومرآة RTL/LTR.",
        "txt_enterprise_headline": "مؤسسة أم واحدة. أنواع متعددة. دخول واحد.",
        "txt_enterprise_lead": "الأبرشيات ومجموعات PE والوزارات تُشغّل K-12 والكليات والجامعات على دفتر واحد.",
    },
    "BR": {
        ...
        "txt_speed_duel_headline": "Quinze cliques vs um comando.",
        "txt_speed_duel_lead": "SIS legados fazem equipes caçar menus aninhados. RunMyCampus compila intenção em tool calls governados.",
        "txt_zero_ui_headline": "Orquestração Zero-UI — acabe com o labirinto de abas.",
        "txt_zero_ui_lead": "Digite o que precisa. Veja o OS compilar JSON estruturado e slots de layout.",
        "txt_trinity_headline": "Feito para a conexão que você realmente tem.",
        "txt_trinity_lead": "De PWA offline em 2G a paredes NOC 4K — mesmo kernel, espelho RTL/LTR.",
        "txt_enterprise_headline": "Uma org pai. Vários tipos de instituição. Um login.",
        "txt_enterprise_lead": "Dioceses, PE e ministérios operam K-12, politécnicos e universidades em um ledger.",
    },
}
