...
from .super_views_helpers import (
    ...
    safe_school_timeline_url as _safe_school_timeline_url,
)
...
def super_dashboard_v2(request):
    ...
    for school in schools:
        ...
        school.has_brand_profile = (
            ...
            or _brand_profile_for_school(school) is not None
        )
        school.brand_status = (
        ...
        school.identity_tone = _status_tone(
    ...
    return render(
        ...
        "schools/super_dashboard.html",
        {
            ...
            "countries_live_pct": _safe_percentage(
            ...
            "super_dashboard_section_order": _get_super_dashboard_section_order(
                request.user
            ),
