    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("route", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="stops", to="schools.route")),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("is_active", models.BooleanField(default=True)),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("route", models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name="buses", to="schools.route")),
        ...
        migrations.AddConstraint(
            model_name="route",
            constraint=models.UniqueConstraint(fields=("school", "name"), name="schools_route_school_name_uniq"),
        ),
        migrations.AddConstraint(
            model_name="stop",
            constraint=models.UniqueConstraint(fields=("route", "sequence"), name="schools_stop_route_seq_uniq"),
        ),
        migrations.AddConstraint(
            model_name="bus",
            constraint=models.UniqueConstraint(fields=("school", "identifier"), name="schools_bus_school_id_uniq"),
        ),
    ]
