...
def _get_role_choices():
    """Inlined from ``apps.schools.models._get_role_choices`` for migration
    historical-state safety. Uses the Django app registry via importlib so the
    migration file does not carry a top-level live-model import.
    """
    import importlib

    user_model = importlib.import_module("apps.accounts.models").User
    return user_model.Role.choices
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "slug",
                    models.SlugField(
                        help_text="URL slug e.g. ghs-limbe", max_length=120, unique=True
                    ),
                ),
                ...
                (
                    ...
                    models.URLField(
                        blank=True,
                        help_text="URL to school logo (e.g. from tenants/{id}/logo.png)",
                    ),
                ),
