    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("payload", models.JSONField(blank=True, default=dict, help_text="Row data (sanitized).")),
                ...
                (
                    ...
                    models.CharField(
                        db_index=True,
                        max_length=20,
                        choices=[("PENDING", "Pending"), ("REPAIRED", "Repaired"), ("FAILED", "Failed")],
                        default="PENDING",
                    ),
                ),
                ("resolved_at", models.DateTimeField(blank=True, null=True)),
                ("resolution_payload", models.JSONField(blank=True, default=dict, help_text="Repaired row or resolution note.")),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=["school", "domain", "status"], name="automation_quarantine_school_domain_status_idx"),
        ),
    ]
