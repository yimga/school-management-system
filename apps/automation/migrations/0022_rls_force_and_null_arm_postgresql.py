"""Force-bind row-level security for automation (198-table burndown, 2026-09-03).
...
def _policy_name(table):
    ...
    return f"automation_rls_{suffix}"
...
class Migration(migrations.Migration):
    ...
    dependencies = [("automation", "0021_rls_policy_default_deny")]
