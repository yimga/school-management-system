...
- **Tenant/default host**: `/`, `/health/`, `/healthz/`, `/admin/`, `/authentication/login/`, `/authentication/backend/`, `/portal/parent/`, `/finance/`, `/analytics/`, `/compliance/dashboard/`, `/evals/teacher/`, `/payroll/`, `/automation/outcomes/`, `/communication/groups/`, `/requests/`, `/academics/teacher/syllabi/`, `/studio/experience/`, `/siteconfig/customizer/`, `/discover/`, `/support/`, `/verify/`.
