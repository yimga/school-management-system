...
- **Tenant/default host**: `/`, `/health/`, `/healthz/`, `/admin/`, `/authentication/login/`, `/authentication/backend/`, `/portal/parent/`, `/finance/`, `/studio/experience/`, `/siteconfig/customizer/`, `/discover/`, `/support/`, `/verify/`.
