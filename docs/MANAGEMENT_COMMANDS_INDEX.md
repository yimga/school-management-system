...
- ~~Delete obsolete commands~~ **Done:** ensure_gilead_admin removed (NEXT_50 step 6 subtractive cleanup); use ensure_default_tenant_admin. No other obsolete commands to remove.
