...
**Last A+B record (repo cadence slice):** SOT §11.4 **batch 91** (**2026-03-27**) — `lint_gilead_residue.py` + `verify_gilead_full_tree_classification.py` + `test_gilead_full_tree_classification_helpers.py` **PASS** (`files_with_hit=145` at that run).
