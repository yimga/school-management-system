...
**Last updated:** 2026-07-02 (9.8-regime wave 1 — device-governance revocation made real: both mint paths refuse revoked devices + operator revoke/reinstate console. Prior: sovereign-audit A-wave `v4.05.94` offline mint contract; overnight B→A loop.)
