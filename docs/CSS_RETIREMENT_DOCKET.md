...
**Last updated:** 2026-07-02 (9.8-regime wave 2 — cross-rail sync observability: first-ever WAL dead-letter reader + SODP operator rollup + hourly backlog monitor with auto-incident. Prior same day: wave 1 device-governance revocation made real.)
