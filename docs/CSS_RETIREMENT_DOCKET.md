...
**Last updated:** 2026-07-03 (9.8-regime merge/split Wave A — transfer foundations: envelope domain_rows + real student extractor, TransferCase FSM, internal-tenant intake dry-run e2e; found + fixed 3 real advance→apply pipeline bugs incl. the lost mapping/domain persistence pair.)
