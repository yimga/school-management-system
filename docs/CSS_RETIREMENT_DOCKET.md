...
**Last updated:** 2026-07-02 (Sovereign-audit A-wave `v4.05.94`: offline capability mint contract repaired end-to-end; `DATA_RESIDENCY_STRICT_UNKNOWN` fail-closed mode; CRDT policy registry v2 `ONLINE_REQUIRED` tier. Prior: overnight B→A loop — captions to zero, Payment immutability, real axe findings.)
