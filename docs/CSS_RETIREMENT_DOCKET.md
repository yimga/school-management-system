...
**Last updated:** 2026-07-03 (9.8-regime merge/split Wave B — transfer GO-LIVE: consent artifact + real apply + passport link + operator console; real-apply e2e exposed 5 production bugs incl. globally-unique student identifiers making inter-school transfer structurally impossible, and cross-domain MigrationIdMapping clobbering.)
