...
**E. Risks / notes:** Log header was repaired to **UTF-8** where Latin-1 **`§`** / **`ç`** bytes had been introduced.
...
**B. Implementation:** **Tenant settings singleton** / **siteconfig ownership** / **tenant settings façade** phrasing; **`ValueError`** text **`Unknown siteconfig ownership domain`**.
