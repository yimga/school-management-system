...
| §5.9 | Total decomposition; Reclassify; preview/diff/rollback | Large metadata/blueprint scope | (1) Break into backlog. (2) Add bounded consoles per BOUNDED_CONSOLES_INVENTORY.md; reclassify per site_settings_usage_inventory; add preview/diff/rollback in System config. (3) Mark SOT §5.9 [x]. |
...
| **§5.9 System config** | Bounded consoles + reclassify | BOUNDED_CONSOLES_INVENTORY.md; site_settings_usage_inventory |
