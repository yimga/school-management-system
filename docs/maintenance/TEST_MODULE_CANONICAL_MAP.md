...
| `apps.finance.tests.test_regional_payment_profiles` | `apps.finance.tests.test_global_payment_profiles` | Global payments corridor suite consolidated | `python manage.py test apps.finance.tests.test_global_payment_profiles` |
