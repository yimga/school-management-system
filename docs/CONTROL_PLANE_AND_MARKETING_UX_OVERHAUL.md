...
| super_dashboard, super_command_center, governance_console, app_catalog | cp-hero / proof-hero (role-home or catalog) | Keep hero; ensure one primary CTA. **super_command_center:** All 7 queue empty blocks use studio_os/components/loading_empty_states (Pending approvals, Trial watchlist, Provisioning breaches, Stale support, Platform incidents, Billing exceptions, Churn risk). |
| **marketplace/governance_console** | cp-hero (Marketplace governance); data-page-archetype=catalog; Back to Dashboard first + Billing; dashboard_url + catalog_counts in context | **DONE** — §2e row 8 page maturity; catalog_counts wired for catalog strip. |
| **marketplace/app_catalog** | proof-hero (App catalog); data-page-archetype=catalog; Back to Dashboard first + Marketplace governance + Blueprint marketplace + Sandbox inspector | **DONE** — §2e row 8 page maturity. |
| **billing_dashboard** | **studio_os page_header** (Platform billing, subtitle, Back to dashboard) + data-page-archetype=operational-workbench; secondary link Usage API | **DONE** — §2e row 8 page maturity. |
| **marketplace/blueprint_marketplace** | cp-hero (Blueprint marketplace); data-page-archetype=catalog; Governance + App catalog + Control plane | **DONE** — §2e row 8; already had cp-hero + data-page-archetype. |
...
| **studio_os/automation_staged_activation** (Automation Studio) | **studio_os page_header** (Staged activation, subtitle, Back to Automation) + data-page-archetype=operational-workbench | **DONE** — §4.3 optional. |
| **studio_os/automation_replay_rollback** (Automation Studio) | **studio_os page_header** (Replay / rollback, subtitle, Back to Automation) + data-page-archetype=operational-workbench | **DONE** — §4.3 optional. |
...
| **studio_os/automation_visual_builder** (Automation Studio) | **studio_os page_header** (Visual builder, subtitle, Back to Automation) + data-page-archetype=operational-workbench | **DONE** — §4.3 optional. |
| **studio_os/automation_natural_language_workflow** (Automation Studio) | **studio_os page_header** (Natural-language workflow, subtitle, Back to Automation) + data-page-archetype=operational-workbench | **DONE** — §4.3 optional. |
| **studio_os/automation_simulation_engine** (Automation Studio) | **studio_os page_header** (Simulation engine, subtitle, Back to Automation) + data-page-archetype=operational-workbench | **DONE** — §4.3 optional. |
...
| **people/backend_student_create.html** (tenant backend) | **studio_os page_header** (Create Student, subtitle, Back to List) + data-page-archetype=record-detail | **DONE** — §2e row 8 tenant backend page maturity. |
| **people/backend_teacher_create.html** (tenant backend) | **studio_os page_header** (Create Teacher, subtitle, Back to List) + data-page-archetype=record-detail | **DONE** — §2e row 8 tenant backend page maturity. |
| **people/backend_applicant_create.html** (tenant backend) | **studio_os page_header** (Add applicant, subtitle, Back to list) + data-page-archetype=record-detail | **DONE** — §2e row 8 tenant backend page maturity. |
| **people/employer_dashboard.html** (portal) | **studio_os page_header** (Apprentice progress, subtitle) + data-page-archetype=operational-workbench | **DONE** — §2e row 8 page maturity. |
| **people/employer_confirm_hours.html** (portal) | **studio_os page_header** (Confirm on-site hours, subtitle, Back to dashboard) + data-page-archetype=record-detail | **DONE** — §2e row 8 page maturity. |
| **people/employer_transcript.html** (portal) | **studio_os page_header** (Transcript, student as subtitle, Back to dashboard) + data-page-archetype=record-detail | **DONE** — §2e row 8 page maturity. |
...
| **metadata/lineage_graph** (Control Studio rail) | **studio_os page_header** (Lineage graph, subtitle, Back to Control) + data-page-archetype=catalog | **DONE** — §2e row 8 page maturity. |
| **customersuccess/super_dashboard** | **studio_os page_header** (Benchmark & Customer Success, subtitle, Back to dashboard) + data-page-archetype=operational-workbench | **DONE** — §2e row 8 page maturity. |
...
| **siteconfig/tag_manager** (tenant backend) | **studio_os page_header** (Information tags, subtitle, Back to dashboard) + data-page-archetype=operational-workbench | **DONE** — §2e row 8 tenant backend page maturity. |
| **siteconfig/tag_manager_edit** (tenant backend) | **studio_os page_header** (Edit tag, subtitle=tag name, Back to List) + data-page-archetype=record-detail | **DONE** — §2e row 8 tenant backend page maturity. |
...
| **accounts/import_hub** (tenant backend) | **studio_os page_header** (Import Hub, subtitle, Workflow Center) + data-page-archetype=operational-workbench | **DONE** — §2e row 8 tenant backend page maturity. |
| **accounts/migration_run_list** (tenant backend) | **studio_os page_header** (Migration runs, subtitle, Back to Workflow Center) + data-page-archetype=operational-workbench | **DONE** — §2e row 8 tenant backend page maturity. |
| **accounts/legacy_data_cleaner** (tenant backend) | **studio_os page_header** (Legacy data cleaner, subtitle, Back to Workflow Center) + data-page-archetype=operational-workbench | **DONE** — §2e row 8 tenant backend page maturity. |
| **accounts/migration_wizard** (tenant backend) | **studio_os page_header** (Data migration wizard, subtitle, Back to Import Hub) + data-page-archetype=operational-workbench | **DONE** — §2e row 8 tenant backend page maturity. |
| **accounts/migration_legacy_view** (tenant backend) | **studio_os page_header** (Legacy data read-only, run as subtitle, Back to runs) + data-page-archetype=operational-workbench | **DONE** — §2e row 8 tenant backend page maturity. |
| **accounts/workflow_center** (tenant backend) | **studio_os page_header** (Workflow Center, subtitle, Back to Backend) + data-page-archetype=operational-workbench | **DONE** — §2e row 8 tenant backend page maturity. |
| **siteconfig/get_blueprints** (tenant backend / Control Studio embed) | **studio_os page_header** (Blueprints, subtitle, Back to Control when embed=1 else Back to dashboard) + data-page-archetype=catalog | **DONE** — §2e row 8 page maturity; view passes page_title, page_subtitle, action_url, action_text. |
| **apicenter/dashboard** (tenant backend / Control Studio rail) | **studio_os page_header** (Integrations & API Center, subtitle, Back to Control when embed=1 else Back to dashboard) + data-page-archetype=operational-workbench | **DONE** — §2e row 8 page maturity. |
| **siteconfig/workflow_flow_gallery** (tenant backend / Automation Studio rail) | **studio_os page_header** (Workflow Flow Gallery, subtitle, Back to Automation when embed=1 else Back to Workflow hub) + data-page-archetype=operational-workbench | **DONE** — §2e row 8 page maturity. |
| **finance/reports** (tenant backend) | **studio_os page_header** (Finance Intelligence, subtitle, Back to Finance) + data-page-archetype=operational-workbench | **DONE** — §2e row 8 page maturity; view passes page_title, page_subtitle, action_url. |
| **finance/split_allocation**, **finance/scan_teller_placeholder** | **studio_os page_header** (shared component) | **DONE** — use studio_os/components/page_header.html; Back to Payments. |
| **finance/suspense_queue** (tenant backend) | **studio_os page_header** (Suspense Queue, subtitle, Back to Payments) + data-page-archetype=operational-workbench | **DONE** — §2e row 8; view passes page_title, page_subtitle, action_url. |
| **finance/trial_balance** (tenant backend) | **studio_os page_header** (Trial Balance, compliance as subtitle, Back to Finance) + data-page-archetype=operational-workbench | **DONE** — §2e row 8; view passes page_title, page_subtitle, action_url. |
| **finance/expense_vs_budget** (tenant backend) | **studio_os page_header** (Expense vs Budget, subtitle, Back to Finance) + data-page-archetype=operational-workbench | **DONE** — §2e row 8; view passes page_title, page_subtitle, action_url. |
| **finance/generate_fees** (tenant backend) | **studio_os page_header** (Generate Fee Invoices, subtitle, Back to Finance) + data-page-archetype=operational-workbench | **DONE** — §2e row 8 page maturity. |
| **requests/dashboard** (portal / tenant) | **studio_os page_header** (Access requests, subtitle, Back to dashboard) + data-page-archetype=operational-workbench | **DONE** — §2e row 8 page maturity. |
| **requests/detail** (portal / tenant) | **studio_os page_header** (request reference as title, type as subtitle, Back to list) + data-page-archetype=record-detail | **DONE** — §2e row 8 page maturity. |
| **analytics/strategic_report** (portal / tenant) | **studio_os page_header** (Strategic Reporting, subtitle, Analytics) + data-page-archetype=operational-workbench | **DONE** — §2e row 8 page maturity. |
| **analytics/at_risk_dashboard** (portal / tenant) | **studio_os page_header** (At-Risk Dashboard, subtitle, Back to Analytics) + data-page-archetype=operational-workbench | **DONE** — §2e row 8 page maturity. |
