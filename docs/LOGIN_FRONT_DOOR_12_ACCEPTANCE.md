...
| 3 | Role-aware sign-in | Staff, parent and student role gateway drives previews and post-login intent while server authorization remains authoritative | Login interaction/context tests |
