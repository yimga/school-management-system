...
- `AllowAny`: `34`
- `print()`: `428`
- `gilead` matches: `486` across `112` files
...
- `apps/siteconfig/models.py`: `4477` lines / `174866` bytes
...
- `apps/finance/tasks.py`: `1612` lines / `74358` bytes
