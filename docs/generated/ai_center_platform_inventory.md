...
- `manifest/icon-<int:size>.png` (config/urls.py)
- `manifest/icon-<int:size>-maskable.png` (config/urls.py)
- `offline/sync/` (config/urls.py)
- `api/tour-steps/public/` (config/urls.py)
- `-/version/` (config/urls.py)
- `security/csp-report/` (config/urls.py)
- `api/system/version/` (config/urls.py)
- `version.json` (config/urls.py)
- `i18n/setlang/` (config/urls.py)
- `i18n/setlang/persist/` (config/urls.py)
