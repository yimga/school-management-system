...
|----|------------|----------|--------|----------------|-----------------|
| bank_sepa_card_partner | Bank / SEPA / sponsor bank rails | blocks_full_market | not_started | partial — CARD/BANK rails flagged external_required without PSP | Legal + banking onboarding outside repo |
...
| stripe_global_cards | Stripe — global card payments | blocks_full_market | credentials_needed | partial — integration hooks, webhook scaffolding, metadata health command | Complete Stripe onboarding; configure live keys and webhook endpoint in deployment secrets |
