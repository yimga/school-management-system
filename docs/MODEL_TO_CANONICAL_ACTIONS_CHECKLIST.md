...
| 4 | Align people models to Person + Role Assignment | **Deferred** | Single Person identity root and explicit Role Assignment to be done when refactoring people app. See CANONICAL_OBJECTS_MAPPING. |
...
| people (Student, Staff…) | KEEP; align to Person | Deferred; Person as identity root when refactoring. |
...
| Document Version / Generated Artifact | Future; clarify in reports if needed. |
| Custom Field Definition/Value | Future when productised. |
